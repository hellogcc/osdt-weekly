...
今年的 OSDT 大会，目前很有可能放在12月7日北京。征稿启事有可能下周开始。
...
本节内容来自 [LLVM Weekly 第 617 期](http://llvmweekly.org/issue/617)，
[Alex Bradbury](https://www.linkedin.com/in/alex-bradbury/) 大哥持续稳定输出。

* 宋教授！ Fangrui Song wrote a blog post about [stack walking mechanisms, including the recently developed SFrame format](https://maskray.me/blog/2025-10-26-stack-walking-space-and-time-trade-offs).

* 有人看过么，给点意见？ Jan Korous posted an RFC on a [scalable static analysis framework](https://discourse.llvm.org/t/rfc-scalable-static-analysis-framework/88678).  This work from Apple comes from a prototype effort to implement a source code rewriting tool that uses static analysis methods to apply security hardening across C++ codebases.

* 重要且具有话题性的： Lucile Rose Nihlen [announced the availability of a dashboard to monitor code review and contribution rates over time](https://discourse.llvm.org/t/announcement-llvm-dashboard-to-monitor-code-review-and-contribution-rates-over-time/88680).  The [dashboard](https://llvm.grafana.net/public-dashboards/8f99b2c15f934682977eedc01f148e75) shows status such as LLVM commits per day, what percentage of these commits were landed without pre-commit review etc.

* 或许有意思的交叉： whitequark has an [update on building LLVM for WebAssembly](https://discourse.llvm.org/t/rfc-building-llvm-for-webassembly/79073/61).  A package is now available on NPM.

* 一个重要地方面： Petter Berntsson and the LLVM qualification group are [collecting community input on the qualification of LLVM tools and libraries](https://discourse.llvm.org/t/rfc-collecting-community-input-on-qualification-of-llvm-tools-libraries/88569).

* 《数据结构》：A radix tree LLVM was added to LLVM's datastructure library.
  [5fda2a5](https://github.com/llvm/llvm-project/commit/5fda2a5d9c1a).

* 不断进步： The Hexagon backend gained a new optimisation pass for intermediate conversion instructions while performing vector floating point operations.
  [e8b255d](https://github.com/llvm/llvm-project/commit/e8b255df1bb4).
...
人生总是每个阶段都有伴随着不同的压力。有时候压力逐渐累积到一定强度之后会有突然所有压力都消失的失重感，或者说耳鸣失聪感。能够利用深处风暴眼中的平静制造出闲暇，煮开一壶水，泡点啥，剥点啥，嗑点啥。

我是在今年，才发现出差的路途中揣一把瓜子在口袋里的戏剧性从容感的。
